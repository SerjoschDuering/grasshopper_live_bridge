...
exports.helloPrompts = void 0;
exports.buildHelloPromptMessage = buildHelloPromptMessage;
exports.helloPrompts = [
    {
...
function buildHelloPromptMessage(promptName, args) {
    switch (promptName) {
...
//# sourceMappingURL=hello.prompts.js.map